...
public enum ErrorCode {
    ...
    LOCK_ACQUISITION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "LOCK_ACQUISITION_FAILED"),
    ITEM_INFO_REQUEST_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "ITEM_INFO_REQUEST_FAILED"),
    INVALID_EVENT_STATUS(HttpStatus.BAD_REQUEST, "INVALID_EVENT_STATUS");
